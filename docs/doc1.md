---
id: doc1
title: Utilizando Docusaurus
sidebar_label: Docusaurus
---

Check the [documentation](https://docusaurus.io) for how to use Docusaurus.

Começando a contribuir com a documentação
...
Docusaurus é uma aplicação instalada localmente em cada computador, que facilita o processo de documentação. Ao iniciar o Docusaurus localmente, ele abre um servidor local com porta padrão 3000.
...
Para que a documentação seja criada, é preciso compreender como o Docusaurus funciona, para que ele possa trabalhar com as suas informações. Explicarei o básico para que isso aconteça, mas se desejar aprofundar o conhecimento, veja a seção Mesa de ferramentas (guias) abaixo.
### Criando uma nova página de documentação
    ...
    Crie um arquivo com a extensão .md
        Veja o padrão de nomeação do arquivo ao criá-lo: Padrões de documentação - Padrões definidos
...
### Mesa de ferramentas (guias)

    Documentação Docusaurus (em Inglês)
    Guia Markdown (em Inglês)
...
Dependẽncias para executar este procedimento:
    ...
    Permissão de commit na branch gh-pages do repositório desejado

    2.Acesse o diretório website do projeto: cd i-educar-website/website
    ...
    3.As instruções GIT_USER e CURRENT_BRANCH são variáveis de ambiente utilizadas pelo Docusaurus para realizar a publicação no GitHub Pages.
...
### Problemas mais comuns de documentações:
    ...
    -Falta de padrões (Padrões de documentação)
